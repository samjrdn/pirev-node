...
function getOvervoltage(code) {
  return !((code >> 31) & 0b1);
}

function getOtpProgram(code) {
  return !((code >> 30) & 0b1);
}

function getOtpRead(code) {
  return !((code >> 29) & 0b1);
}

function getWarranty(code) {
  return !((code >> 25) & 0b1);
}
...
module.exports = function (code) {
  ...
  return {
    ...
    overvoltage: getOvervoltage(code),
    otp: {
      program: getOtpProgram(code),
      read: getOtpRead(code),
    },
    warranty: getWarranty(code),
  };
};
