const {EGOMAN, EMBEST, SONY_JAPAN, SONY_UK, STADIUM} = require('./manufacturer');
const {MB_256, MB_512, GB_1} = require('./memory');
const {BCM_2835, BCM_2836, BCM_2837} = require('./processor');
const {A, B, A_PLUS, B_PLUS, B_2, ALPHA, CM_1, B_3, ZERO, CM_3, ZERO_W, B_3_PLUS, A_3_PLUS, CM_3_PLUS} = require('./type');
